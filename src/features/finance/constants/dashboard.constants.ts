...
// GENERAL_NAV_ITEMS and CURRENT_USER used to live here, but Sidebar/TopNav
// are shared components used by every feature, so their defaults moved to
// shared/constants/navigation.constants.ts alongside the other SidebarConfigs.
